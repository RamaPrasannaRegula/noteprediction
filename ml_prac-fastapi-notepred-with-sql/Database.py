...
host_server = os.environ.get('host_server', 'prasanna1.mysql.database.azure.com')
db_server_port = urllib.parse.quote_plus(str(os.environ.get('db_server_port', '3306')))
database_name = os.environ.get('database_name', 'fastapi')
db_username = urllib.parse.quote_plus(str(os.environ.get('db_username', 'prasanna@prasanna1')))
db_password = urllib.parse.quote_plus(str(os.environ.get('db_password', '@Jaihind@2')))
